            ...
            children: [
              Column(
                children: [
                  ...
                  Text('${cautionModel.deliveryUserProfile?.nickname}')
                ],
              ),
              Column(
                children: [
                  ...
                  const Text('Operador'),
                  Text('${cautionModel.receiverUserProfile?.nickname}')
                ],
              ),
              ...
              Column(
                children: [
                  ...
                  Text('${cautionModel.givebackUserProfile?.nickname}')
                ],
              ),
            ],
          ),
          AppImageShow(
            photoUrl: cautionModel.item!.image?.photoUrl,
            height: 100,
            width: 300,
          ),
          AppTextTitleValue(
